...
global.sudo = process.env.SUDO || '940710701946'
global.devs = '94710701946';
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'MR SASIYA BOT' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'SASIYA' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? "VAJIRA;;;AccostedMeetin" : process.env.SESSION_ID,
